...
const FALLBACK_LEGEND = 'rgba(255, 255, 245, 0.68)';
const FALLBACK_TICK = 'rgba(255, 255, 245, 0.46)';
const FALLBACK_GRID = 'rgba(255, 255, 245, 0.08)';
const FALLBACK_FONT_FAMILY = 'IBM Plex Mono, ui-monospace, monospace';
...
export function readChartThemeColors(): ChartThemeColors {
  ...
  const fontFamily = cs.getPropertyValue('--font-mono').trim();
  return {
